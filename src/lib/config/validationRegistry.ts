...
import { isValidSafeUrl } from '../validation/safeUrl'

export { isValidSafeUrl }
...
// isValidSafeUrl now lives in ../validation/safeUrl (extracted during
// CMS-UNIFY-CONFIG-EDITOR); re-exported above so this file keeps one
// canonical implementation instead of a second copy that could drift.
